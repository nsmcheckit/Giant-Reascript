...
local ret, track_name = reaper.GetProjExtState( 0, "reaperWeb", "trackname" )
-- Message function
function Msg(str)
...
-- reaper.SetMediaTrackInfo_Value(reaper.GetSelectedTrack( 0, 0 ),"I_FOLDERDEPTH", 1)--insert child
reaper.GetSetMediaTrackInfo_String( reaper.GetSelectedTrack(0,0), "P_NAME", track_name, true )
